<?php
/**
 * AJAX контролер модуля "Рада ветеранів".
 *
 * Version:     1.1.0
...
class Veterans_Ajax {
    ...
    private Veterans_Repository $repository;

    public function __construct() {
        $this->repository = new Veterans_Repository();
    }

    public function init(): void {
        add_action( 'wp_ajax_fstu_veterans_get_members', [ $this, 'handle_get_members' ] );
        add_action( 'wp_ajax_nopriv_fstu_veterans_get_members', [ $this, 'handle_get_members' ] );
        add_action( 'wp_ajax_fstu_veterans_delete', [ $this, 'handle_delete_member' ] );
    }
    ...
    public function handle_delete_member(): void {
        ...
        if ( ! current_user_can( Capabilities::DELETE_VETERANS ) && ! current_user_can( 'manage_options' ) ) {
