...
class Capabilities {
    ...
    public const VIEW_PART                     = 'fstu_view_part';
    public const MANAGE_PART                   = 'fstu_manage_part';
    public const VIEW_PART_PROTOCOL            = 'fstu_view_part_protocol';
	...
	public static function register_role_capabilities(): void {
		...
		$role_caps = [
			'administrator' => [
                ...
                self::VIEW_PART                     => true,
                self::MANAGE_PART                   => true,
                self::VIEW_PART_PROTOCOL            => true,
