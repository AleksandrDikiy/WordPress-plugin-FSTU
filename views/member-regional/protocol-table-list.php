<?php
/**
 * Протокол (журнал операцій) довідника посад федерацій.
 *
 * Version:     1.0.0
...
<div id="fstu-member-regional-protocol" class="fstu-hidden">
	<div class="fstu-table-wrap fstu-table-wrap--compact">
		<table class="fstu-table fstu-table--compact">
				...
				<tr>
					...
					<th class="fstu-th fstu-th--wide-name">
						<div class="fstu-th-with-search">
							...
							<input
								type="text"
								id="fstu-member-regional-protocol-search"
			...
			<tbody class="fstu-tbody" id="fstu-member-regional-protocol-tbody">
				<tr class="fstu-row">
	...
	<div class="fstu-pagination fstu-pagination--compact">
		<div class="fstu-pagination__left">
			<label class="fstu-pagination__per-page-label" for="fstu-member-regional-protocol-per-page"><?php esc_html_e( 'Показувати по:', 'fstu' ); ?></label>
			<select id="fstu-member-regional-protocol-per-page" class="fstu-select fstu-select--compact" aria-label="<?php esc_attr_e( 'Кількість записів протоколу на сторінці', 'fstu' ); ?>">
		...
		<div class="fstu-pagination__controls">
			<button type="button" class="fstu-btn--page" id="fstu-member-regional-protocol-prev-page">«</button>
			<div id="fstu-member-regional-protocol-pagination-pages"></div>
			<button type="button" class="fstu-btn--page" id="fstu-member-regional-protocol-next-page">»</button>
		</div>
		<div class="fstu-pagination__info">
			<span id="fstu-member-regional-protocol-pagination-info" aria-live="polite"></span>
		</div>
	</div>
</div>
