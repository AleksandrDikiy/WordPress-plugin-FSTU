        ...
        <div class="fstu-modal__body">
            ...
            <form id="fstu-member-regional-form" class="fstu-app-form" novalidate>
                ...
                <div class="fstu-form-actions">
                    <button type="submit" class="fstu-btn fstu-btn--save" id="fstu-member-regional-form-submit"><?php esc_html_e( 'Зберегти', 'fstu' ); ?></button>
                    <button type="button" class="fstu-btn fstu-btn--cancel" data-close-modal="fstu-member-regional-form-modal"><?php esc_html_e( 'Скасувати', 'fstu' ); ?></button>
                </div>
            </form>
        </div>
    </div>
