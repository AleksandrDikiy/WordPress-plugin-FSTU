<?php 
/**
 * Протокол (журнал операцій) "Довідник типів заходів".
 *
 * Version:     1.0.0
...
<div class="fstu-table-wrap">
	<table class="fstu-table" id="fstu-protocol-table">
			...
			<tr>
				...
				<th class="fstu-th fstu-th--wide-name">
					<div class="fstu-th-with-search">
						<span>Операція</span>
						<input type="text" id="fstu-protocol-search" class="fstu-input--in-header" placeholder="🔍 Пошук по протоколу...">
					</div>
				</th>
		...
		<tbody id="fstu-protocol-tbody"><tr><td colspan="6" style="text-align:center;">Завантаження...</td></tr></tbody>
	</table>
	...
	<div class="fstu-pagination fstu-pagination--compact">
		...
		<div class="fstu-pagination__controls" id="fstu-protocol-pages"></div>
