<?php
/**
 * Таблиця списку довідника видів складності походів.
 *
 * Version:     1.0.0
	...
	<table class="fstu-table">
		<thead class="fstu-thead">
			<tr>
				...
				<th class="fstu-th fstu-th--code"><?php esc_html_e( 'Код категорії', 'fstu' ); ?></th>
				<th class="fstu-th fstu-th--actions"><?php esc_html_e( 'Дії', 'fstu' ); ?></th>
			</tr>
		</thead>
		<tbody class="fstu-tbody" id="fstu-hourcategories-tbody">
			<tr class="fstu-row">
