<?php
/**
 * Таблиця списку комісій та колегій.
	...
	<table class="fstu-table">
		<thead class="fstu-thead">
			<tr>
				...
				<th class="fstu-th fstu-th--email"><?php esc_html_e( 'Google Group', 'fstu' ); ?></th>
				<th class="fstu-th fstu-th--number"><?php esc_html_e( '№ статті/сторінки', 'fstu' ); ?></th>
				<th class="fstu-th fstu-th--actions"><?php esc_html_e( 'Дії', 'fstu' ); ?></th>
			</tr>
		</thead>
		<tbody class="fstu-tbody" id="fstu-commission-tbody">
			<tr class="fstu-row">
