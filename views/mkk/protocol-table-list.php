<?php
/**
 * Протокол модуля «Реєстр членів МКК ФСТУ».
 *
 * Version:     1.0.0
...
<div id="fstu-mkk-protocol" class="fstu-hidden">
	<div class="fstu-table-wrap fstu-table-wrap--compact">
		<table class="fstu-table fstu-table--compact">
			...
			<tbody class="fstu-tbody" id="fstu-mkk-protocol-tbody">
				<tr class="fstu-row">
	...
	<div class="fstu-pagination fstu-pagination--compact">
		<div class="fstu-pagination__left">
			<label class="fstu-pagination__per-page-label" for="fstu-mkk-protocol-per-page"><?php esc_html_e( 'Показувати по:', 'fstu' ); ?></label>
			<select id="fstu-mkk-protocol-per-page" class="fstu-select fstu-select--compact" aria-label="<?php esc_attr_e( 'Кількість записів протоколу на сторінці', 'fstu' ); ?>">
		...
		<div class="fstu-pagination__controls">
			<button type="button" class="fstu-btn--page" id="fstu-mkk-protocol-prev-page">«</button>
			<div id="fstu-mkk-protocol-pagination-pages"></div>
			<button type="button" class="fstu-btn--page" id="fstu-mkk-protocol-next-page">»</button>
		</div>
		<div class="fstu-pagination__info">
			<span id="fstu-mkk-protocol-pagination-info" aria-live="polite"></span>
		</div>
	</div>
</div>
