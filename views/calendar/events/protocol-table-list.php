<?php
/**
 * Протокол підмодуля Calendar_Events.
 *
 * Version: 1.0.0
...
<div id="fstu-calendar-protocol" class="fstu-hidden">
	<div class="fstu-table-wrap fstu-table-wrap--compact">
		<table class="fstu-table fstu-table--compact">
				...
				<tr>
					...
					<th class="fstu-th fstu-th--wide-name">
						<div class="fstu-th-with-search">
							...
							<input type="text" id="fstu-calendar-protocol-search" class="fstu-input--in-header" placeholder="<?php esc_attr_e( '🔍 Пошук...', 'fstu' ); ?>" autocomplete="off">
						</div>
					</th>
			...
			<tbody id="fstu-calendar-protocol-tbody" class="fstu-tbody">
				<tr>
	...
	<div class="fstu-pagination fstu-pagination--compact">
		<div class="fstu-pagination__left">
			<label class="fstu-pagination__per-page-label" for="fstu-calendar-protocol-per-page"><?php esc_html_e( 'Показувати по:', 'fstu' ); ?></label>
			<select id="fstu-calendar-protocol-per-page" class="fstu-select fstu-select--compact">
		...
		<div class="fstu-pagination__controls">
			<button type="button" class="fstu-btn--page" id="fstu-calendar-protocol-prev-page">«</button>
			<div id="fstu-calendar-protocol-pagination-pages"></div>
			<button type="button" class="fstu-btn--page" id="fstu-calendar-protocol-next-page">»</button>
		</div>
		<div class="fstu-pagination__info">
			<span id="fstu-calendar-protocol-pagination-info" aria-live="polite"></span>
		</div>
	</div>
</div>
