<?php
/**
 * Протокол (журнал операцій) довідника областей.
 *
 * Version:     1.0.0
...
<div id="fstu-region-protocol" class="fstu-hidden">
	<div class="fstu-table-wrap fstu-table-wrap--compact">
		<table class="fstu-table fstu-table--compact">
				...
				<tr>
					...
					<th class="fstu-th fstu-th--wide-name">
						<div class="fstu-th-with-search">
							...
							<input
								type="text"
								id="fstu-region-protocol-search"
								class="fstu-input--in-header"
								placeholder="<?php esc_attr_e( '🔍 Пошук...', 'fstu' ); ?>"
								aria-label="<?php esc_attr_e( 'Пошук по протоколу областей', 'fstu' ); ?>"
								autocomplete="off"
							>
						</div>
					</th>
			...
			<tbody class="fstu-tbody" id="fstu-region-protocol-tbody">
				<tr class="fstu-row">
	...
	<div class="fstu-pagination fstu-pagination--compact">
		<div class="fstu-pagination__left">
			<label class="fstu-pagination__per-page-label" for="fstu-region-protocol-per-page"><?php esc_html_e( 'Показувати по:', 'fstu' ); ?></label>
			<select id="fstu-region-protocol-per-page" class="fstu-select fstu-select--compact" aria-label="<?php esc_attr_e( 'Кількість записів протоколу на сторінці', 'fstu' ); ?>">
		...
		<div class="fstu-pagination__controls">
			<button type="button" class="fstu-btn--page" id="fstu-region-protocol-prev-page">«</button>
			<div id="fstu-region-protocol-pagination-pages"></div>
			<button type="button" class="fstu-btn--page" id="fstu-region-protocol-next-page">»</button>
		</div>
		<div class="fstu-pagination__info">
			<span id="fstu-region-protocol-pagination-info" aria-live="polite"></span>
		</div>
	</div>
</div>
