<?php
/**
 * Протокол (журнал операцій) довідника видів походів.
 *
 * Version:     1.0.0
...
<div id="fstu-tourtype-protocol" class="fstu-hidden">
	<div class="fstu-table-wrap fstu-table-wrap--compact">
		<table class="fstu-table fstu-table--compact">
				...
				<tr>
					...
					<th class="fstu-th fstu-th--wide-name">
						<div class="fstu-th-with-search">
							...
							<input
								type="text"
								id="fstu-tourtype-protocol-search"
			...
			<tbody class="fstu-tbody" id="fstu-tourtype-protocol-tbody">
				<tr class="fstu-row">
	...
	<div class="fstu-pagination fstu-pagination--compact">
		<div class="fstu-pagination__left">
			<label class="fstu-pagination__per-page-label" for="fstu-tourtype-protocol-per-page"><?php esc_html_e( 'Показувати по:', 'fstu' ); ?></label>
			<select id="fstu-tourtype-protocol-per-page" class="fstu-select fstu-select--compact" aria-label="<?php esc_attr_e( 'Кількість записів протоколу на сторінці', 'fstu' ); ?>">
		...
		<div class="fstu-pagination__controls">
			<button type="button" class="fstu-btn--page" id="fstu-tourtype-protocol-prev-page">«</button>
			<div id="fstu-tourtype-protocol-pagination-pages"></div>
			<button type="button" class="fstu-btn--page" id="fstu-tourtype-protocol-next-page">»</button>
		</div>
		<div class="fstu-pagination__info">
			<span id="fstu-tourtype-protocol-pagination-info" aria-live="polite"></span>
		</div>
	</div>
</div>
